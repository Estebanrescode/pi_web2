    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="border border-gray-300 rounded-lg p-4 flex items-center space-x-3 cursor-pointer hover:bg-gray-50">
          ...
          <label
            htmlFor="creditCard"
            className="text-lg font-medium text-black flex-grow"
          >
          ...
          <Image
            ...
            alt="Tarjetas"
            width={60} // Ajusta si quieres otro tamaño
            height={24}
          />
        </div>

        {/* Campos adicionales si se selecciona tarjeta */}
        ...
        <div className="border border-gray-300 rounded-lg p-4 flex items-center space-x-3 cursor-pointer hover:bg-gray-50">
          ...
          <Image
            src="/images/visa-mastercard.png"
            alt="Métodos de pago"
            width={60} // Ajusta según tamaño deseado
            height={24}
          />
        </div>
